...
//        chart.xAxis.granularity = 1F
        ...
        coroutineScope.launch(Dispatchers.IO) {
            ...
            if (isTimeout) {
                this@MainActivity_backup.runOnUiThread{
                    NetworkErrorPrompt()
    ...
    fun NetworkErrorPrompt() {
        ...
        val builder = AlertDialog.Builder(this@MainActivity_backup)
...
//        }
        ...
        val sharedPreference: SharedPreferences =  this@MainActivity_backup.getSharedPreferences("PREFERENCE_NAME",Context.MODE_PRIVATE)
...
//            }else{
        ...
        btnLaunch.setOnClickListener {
            this@MainActivity_backup.recreate()
        }
